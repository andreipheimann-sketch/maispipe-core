...
//
// Roteamento interno por ?action=start|callback|status|disconnect
...
export default async function handler(req, res) {
  ...
  switch (action) {
    ...
    default:
      return res.status(400).json({ error: "Parâmetro 'action' inválido ou ausente. Use start, callback, status ou disconnect." });
  }
}
