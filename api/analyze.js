...
export default async function handler(req, res) {
  ...
  const prompt = [
    "Voce e um analista de inteligencia comercial B2B especializado em seguranca da informacao, ciberseguranca, privacidade de dados (LGPD) e compliance no Brasil — com o perfil da El Canary Privacy & Ethics.",
    "Analise o documento e retorne APENAS um JSON valido nesta estrutura exata:",
    '{"resumo":"Resumo executivo em 3-4 frases: o que a empresa faz, porte, maturidade tecnologica aparente e exposicao a riscos de seguranca e privacidade","insights":["insight 1","insight 2","insight 3","insight 4","insight 5"],"oportunidades":["oportunidade El Canary 1 — ex: ausencia de CISO dedicado, adequacao LGPD incompleta","oportunidade 2","oportunidade 3"],"alertas":["risco ou sinal de imaturidade em seguranca 1","risco 2"]}',
    "Empresa: " + (company || "nao informada") + ".",
    "Foque no que ajuda um consultor da El Canary a identificar oportunidades de EC Governance (CISO as-a-Service), EC Operations (Gestao de Vulnerabilidades, Pentest) e EC Ethics (DPO, LGPD, Governanca de IA) para esta empresa.",
  ].join("\n");
